...
export default function Mode() {
  ...
  return (
    <div
      onClick={handleClick}
      className="h-10 z-10 w-10 border-[0.5px] shadow-2xs transition-transform duration-300 ease-in-out hover:scale-95 shadow-zinc-500/50 rounded-full border-zinc-500/60 cursor-pointer fixed right-6 bottom-6 dark:bg-black bg-zinc-50 dark:text-zinc-50 text-gray-900"
    >
