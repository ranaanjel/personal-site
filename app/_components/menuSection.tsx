        ...
        <div className="h-auto border border-zinc-300/40 rounded-sm">
          {BlogData.map((obj, index) => {
            ...
            return (
              ...
              >
                <span className="p-2 text-md dark:text-zinc-300/40 text-black/40">
                  {(index + 1).toString().padStart(2, "0")}
                </span>
                <span className="text-md p-2 w-65 text-ellipsis overflow-hidden text-nowrap">
                  {obj.title}
                </span>
                <span className="text-xs flex justify-center items-center tracking-tight uppercase p-2 border border-zinc-300/30 rounded-lg">
                  {tag}
                </span>
                <span className="p-2 text-sm text-gray-900/40 dark:text-zinc-300/50">
                  {obj.date}
                </span>
              </div>
            );
